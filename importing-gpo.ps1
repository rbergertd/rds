...
new-gpo -name "Configure RDS Graphics" -Comment "Configure the appropriate GPO's for best graphic performance via RDP"
import-gpo -backupid E802E58D-C478-4AB6-8437-830DF35761AA -TargetName "Configure RDS Graphics" -Path C:\GPOBackup
new-gplink -name "Configure RDS Graphics" -Enforced Yes -LinkEnabled Yes -Target $GPLinkTarget
